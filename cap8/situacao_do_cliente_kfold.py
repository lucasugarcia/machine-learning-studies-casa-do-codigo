...
modelo_one_vs_rest = OneVsRestClassifier(LinearSVC(random_state = 0, max_iter = 100000))
...
modeloOneVsOne = OneVsOneClassifier(LinearSVC(random_state = 0, max_iter = 100000))
